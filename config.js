...
module.exports = {
  ...
  subtitle: `
    ...
    Blackbuck, using a broad range of technologies,
    most notably JavaScript, React, Redux, Angular, CSS.
  `,
  copyright: '',
  disqusShortname: '',
  postsPerPage: 4,
  googleAnalyticsId: 'UA-166047794-1',
  useKatex: false,
  menu: [
    {
      label: 'Articles',
  ...
  author: {
    ...
    photo: '/me.jpg',
    bio: `
      People oriented human. Frontend developer.
    `,
    contacts: {
      email: '',
      facebook: '',
      telegram: '',
      twitter: 'madddyrules',
      github: 'madhankumar028',
      rss: '',
      vkontakte: '',
      linkedin: 'madddymadhan',
      instagram: '',
      line: '',
      gitlab: '',
      weibo: '',
